namespace beach
{
    ...
    {
        let gradient: CanvasGradient = crc2.createLinearGradient(0, 427, 0, 0);
    ...
    {
        let gradient: CanvasGradient = crc2.createLinearGradient(0, 427, 0, 854);
    ...
    {
        let gradient: CanvasGradient = crc2.createLinearGradient(0, 854, 0, 1280);
    ...
    {
        let nParticle: number = 40;
        let rParticle: number = 70;
        ...
        for (let position: number = 0; position < nParticle; position++) 
        {
            crc2.save();

            let x: number = (Math.random() * (_x + 100));
            let y: number = -((Math.random() - 0.5) * _y);
    ...
    function drawGull(_x: number, _y: number): void
    {
        let x: number = Math.floor(Math.random() * 50) + _x;
        let y: number = Math.floor(Math.random() * 50) + _y;
    ...
    {
        let x: number = Math.floor(Math.random() * 100) + _x;
        let y: number = Math.floor(Math.random() * 250) + _y;
    ...
    function drawBall(_x: number, _y: number): void
    {
        ...
        let gradient: CanvasGradient = crc2.createRadialGradient(x, y, 0, x, y, r);
